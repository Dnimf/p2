...
# frotas de cada pais
numero_pais = {1:'Brasil', 2:'França', 3:'Australia', 4:'Rússia', 5:'Japão'}
...
while True:
    ...
    while linha < 0 or linha > 9:
        print('Linha invalida')
        linha = int(input('Informe a linha: '))-1
    if mapa_comp[linha_jogada][coluna_jogada] == 'N':
